...
import { Calendar, Bus,} from 'lucide-react-native';
...
export default function TransportReservationForm() {
  ...
  const [hoursOptions, setHoursOptions] = useState<SelectItem[]>([{ label: i18n.t('select'), value: '' }]);
  ...
  const [nomTouched, setNomTouched] = useState(false);
      ...
      const [departurePlaceTouched, setDeparturePlaceTouched] = useState(false);
  ...
  const resetForm = () => {
    ...
    setEmailError('');
    setReservationCodeTouched(false);
    setReservationCodeError('');
    setAdultesTouched(false);
    setAdultesError('');
    setDeparturePlaceTouched(false);
  ...
  const handleTimeChange = (selectedHour) => {
    ...
    if (selectedOption?.data?.prix_adult !== undefined) {
  ...
  const handleSubmit = async () => {
    setIsvalide(true);
        let formIsValid = true;
            ...
            setNomTouched(true);
            if (!lastName) { setNomError(' '); formIsValid = false; } else { setNomError(''); }

            // Validation Prenom
            setPrenomTouched(true);
            if (!firstName) { setPrenomError(' '); formIsValid = false; } else { setPrenomError(''); }
            ...
            if (adults < 1 || isNaN(adults)) { setAdultesError(' '); formIsValid = false; } else { setAdultesError(''); }
            setDateTouched(true);
    ...
    try {
      ...
      if (result.success) {
        ...
        } else if (result.data.free || result.data.paymentStatus === 'COMPLETED') {
          setSuccessMessageVisible(true);
        }
      } else {
      ...
      Alert.alert('Erreur', i18n.t('errorOccurred'));
    }
  };
                    ...
                    <View style={Formstyles.formContainer}>
                      ...
                      <View style={Formstyles.FlexContainer}>
                        <View style={Formstyles.inputField}>
                          <Input
                            label={i18n.t('name')}
                            value={lastName}
                            onChangeText={(text) => { setLastName(text); setNomTouched(true); setNomError(text ? '' : ' ');}} onBlur={() => { setNomTouched(true); setNomError(lastName ? '' : ' '); }} touched={nomTouched} isvalide={isvalide} error={nomError}
                          />
                        </View>
                        <View style={Formstyles.inputField}>
                          <Input
                            ...
                            value={firstName}
                            onChangeText={(text) => { setFirstName(text); setPrenomTouched(true); setPrenomError(text ? '' : ' ');}} onBlur={() => { setPrenomTouched(true); setPrenomError(firstName ? '' : ' '); }} touched={prenomTouched} isvalide={isvalide} error={prenomError}
                          />
                        </View>
                      </View>
                      ...
                      <View style={Formstyles.FlexContainer}>
                        ...
                        <View style={Formstyles.inputField}>
                          <Input
                            ...
                            onChangeText={(text) => { setReservationCode(text); setReservationCodeTouched(true); setReservationCodeError(text ? '' : ' ');}} onBlur={() => { setReservationCodeTouched(true); setReservationCodeError(reservationCode ? '' : ' '); }} touched={reservationCodeTouched} isvalide={isvalide} error={reservationCodeError}
                          />
                        </View>
                      </View>
                      ...
                      <Select
                        ...
                        onValueChange={value => {
                          ...
                          setDeparturePlaceError(!value || value === 'choisir' ? i18n.t('errorDeparturePlace') : '');
                        }}
                        items={lieux}
                      ...
                      <Select
                        ...
                        onValueChange={value => {
                          ...
                          setDepartureTimeError(!value ? i18n.t('errorDepartureTime') : '');
                        }}
                        items={hoursOptions}
                      ...
                      <View style={Formstyles.FlexContainer}>
                          ...
                          <Input
                            ...
                            onChangeText={(text) => {
                                                    ...
                                                    onBlur={() => {
                                                      ...
                                                      setAdultesTouched(true);
                                                      setAdultesError(adults < 1 || isNaN(adults) ? ' ' : '');
                                                    }}
                        ...
                        <View style={Formstyles.inputField}>
                          <Input
                            ...
                            onChangeText={(text) =>{ setChildren(Number(text)); setEnfantsTouched(true); setEnfantsError(nom ? '' : ' ');}} onBlur={() => { setEnfantsTouched(true); setEnfantsError(nom ? '' : ' '); }} touched={enfantsTouched} isvalide={isvalide} keyboardType="numeric"
                          />
                        </View>
                      </View>
